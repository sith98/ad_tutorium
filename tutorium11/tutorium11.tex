...
\begin{aufgabe}{1}{Tiefensuche}
    \begin{enumerate}
        ...
        \emph{Wenn während einer Tiefensuche auf einem ungerichteten Graphen eine Kante $(u, v)$ betrachtet wird, ist $v$ niemals schwarz.}
        \item Zeigen oder widerlegen Sie folgende Aussage:
        \emph{Wenn während einer Tiefensuche auf einem gerichteten, azyklischen Graphen eine Kante $(u, v)$ betrachtet wird, ist $v$ niemals grau.}
    \end{enumerate}
\end{aufgabe}
...
\begin{aufgabe}{2}{Minimale Spannbäume}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item In $G_2$ gilt $\forall (u, v) \in E$: $w(u, v) = \{1, 2, \ldots, |E|\}$.
...
\begin{aufgabe}{3}{Kürzeste Wege}
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        Durchlaufen Sie Kanten $(u, v)$ alphabetisch~(nach $u$, dann nach $v$).
